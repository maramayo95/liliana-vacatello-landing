...
const About = () => {
  return (
    <section className=" flex flex-col mt-10 bg-green-dark xl:flex-row  xl:py-14 w-[100vw]  ">
      <div className="flex flex-col xl:flex-row m-auto w-full sm:container 2xl:max-w-screen-xl">
        <div className="mt-6 flex justify-center items-center">
            <Image className="py-5 w-full h-auto px-10" src="/about.png" alt="Picture of the author"  width={500} height={500}
            />
        </div>

        <div className="px-10 my-6 xl:w-1/2  flex flex-col justify-center ">
